...
data_raw <- read_delim("H:/MultiCam/2025-10-07-reboot/11_28_2025/Width_1/Left_Leg.txt", delim = '\t', col_names = FALSE)
...
lhip_df <- df_long %>% filter(joint == "LHIP", group != "G0") # filtering
...
# Save the plot
ggsave(filename = "04_15_2026_LHIP.png", plot = complete_plot, width = 8, height = 6, dpi = 600)

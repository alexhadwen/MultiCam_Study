# ----------
# This code was essentially a trial to find all the areas between the camera groups that exhibited significant differences. I used this
# knowledge almost as a baseline to go back and add something similar to the main code just using LME instead.
# ----------
